        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('dashboard.warehouses.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('warehouse_name')}}" class="form-control"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('warehouse_address')}}" placeholder="Enter Warehouse Address"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{old('warehouse_phone')}}" placeholder=" Enter Warehouse Phone #"
