        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('dashboard.suppliers.update' , $supplier->username) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('fname',$supplier->fname)}}" class="form-control"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('lname', $supplier->lname)}}" placeholder="Last Name"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="email" value="{{old('email' , $supplier->email)}}" placeholder="Email"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{old('phone' , $supplier->phone)}}" placeholder="Phone"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('address' , $supplier->address)}}" placeholder="Address"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <x-label for="password_confirmation" :value="__('Confirm Password (Optional)')" />
